 ...
 * @date 2020/1/7
 **/
@ApiModel(description = "创建选择性披露电子凭证接口模板")
public class CreateSelectiveCredentialModel {

    @ApiModelProperty(name = "credential", value = "披露配置", required = true,
        example = "{\n"
    ...
    @ApiModelProperty(name = "fieldsToBeDisclosed", value = "披露配置", required = true,
        example = "{\n"
            + "    \"age\": 1,\n"
            + "    \"name\": 0,\n"
            + "    \"gender\": 1\n"
            + "}")
    private Map<String, Object> fieldsToBeDisclosed;
    ...
    public Map<String, Object> getFieldsToBeDisclosed() {
        return fieldsToBeDisclosed;
    }

    public void setFieldsToBeDisclosed(Map<String, Object> fieldsToBeDisclosed) {
        this.fieldsToBeDisclosed = fieldsToBeDisclosed;
    }
}
